				...
				<div class="menu">
					<nav class="menu nav d-flex ml-2">
	                    <ul class="nav flex-column d-flex">
	                        ...
	                        <li class="nav-item mt-5"><a href="#" class="nav-link main-link text-dark"><img width="40" src="https://cdn-icons-png.flaticon.com/128/5393/5393061.png"><b class="ml-3">내 프로필</b></a></li>
	                    </ul>
					</nav>
				</div>
			</div>